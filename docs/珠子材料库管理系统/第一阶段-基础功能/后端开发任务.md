...
```typescript
@Controller('api/bead-material/categories')
@ApiTags('珠子材料分类管理')
export class CategoriesController {
  ...
  async findAll(@Body() queryDto: QueryCategoryDto) {
    try {
  ...
  async create(
    ...
    try {
      return await this.categoriesService.create(createDto, req.user.id);
    } catch (error) {
  ...
  async update(
    ...
    try {
      return await this.categoriesService.update(updateDto, req.user.id);
    } catch (error) {
...
```typescript
@Controller('api/bead-material/materials')
@ApiTags('珠子材料管理')
export class MaterialsController {
  ...
  async findAll(@Body() queryDto: QueryMaterialDto) {
    try {
      return await this.materialsService.findAll(queryDto);
    } catch (error) {
      throw new BadRequestException(error.message);
    }
  }
  ...
  async create(
    ...
    try {
      return await this.materialsService.create(createDto, req.user.id);
    } catch (error) {
      if (error instanceof ConflictException || error instanceof NotFoundException) {
        throw error;
      }
  ...
  async update(
    ...
    try {
      return await this.materialsService.update(updateDto, req.user.id);
    } catch (error) {
  ...
  @Post('batch')
  @ApiOperation({ summary: '批量操作材料' })
  async batchOperation(
    @Body() batchDto: BatchOperationDto,
    @Request() req
  ) {
    try {
      return await this.materialsService.batchOperation(batchDto, req.user.id);
    } catch (error) {
      throw new BadRequestException(error.message);
    }
  }
  ...
  @Post('search')
  @ApiOperation({ summary: '搜索材料' })
  async search(@Body() searchDto: QueryMaterialDto) {
    try {
      return await this.materialsService.search(searchDto);
    } catch (error) {
      throw new BadRequestException(error.message);
    }
  }
